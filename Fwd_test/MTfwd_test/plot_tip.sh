...
ext=lateral
sitefile=result_${ext}/site_mt.dat
infile1=result_${ext}/A02_TIP.dat
infile2=result_${ext}/A04_TIP.dat
infile3=result_${ext}/A01_TIP.dat
infile4=result_${ext}/A03_TIP.dat

gmt begin ${ext}_tip pdf
