...
#$Da | awk '{print($1,$2,$10)}' | gmt plot $S -Ey+p0.5,blue+w0.2 -W1,blue
...
#$Da | awk '{print($1,$4,$12)}' | gmt plot $S -Ey+p0.5,red+w0.2 -W1,red
...
#$Da | awk '{print($1,$6,$14)}' | gmt plot $S -Ey+p0.5,purple+w0.2 -W1,purple
...
#$Da | awk '{print($1,$8,$16)}' | gmt plot $S -Ey+p0.5,green+w0.2 -W1,green
$Da | awk '{print($1,$16+$16)}' | gmt plot -Si0.2 -W1,green -Ggreen
$Da | awk '{print($1,$16-$16)}' | gmt plot -St0.2 -W1,green -Ggreen
...
#$Dp | awk '{print($1,$3,$11)}' | gmt plot $S -Ey+p0.5,blue+w0.2 -W1,blue
...
#$Dp | awk '{print($1,$5,$13)}' | gmt plot $S -Ey+p0.5,red+w0.2 -W1,red
...
#$Dp | awk '{print($1,$7,$15)}' | gmt plot $S -Ey+p0.5,purple+w0.2 -W1,purple
...
#$Dp | awk '{print($1,$9,$17)}' | gmt plot $S -Ey+p0.5,green+w0.2 -W1,green
