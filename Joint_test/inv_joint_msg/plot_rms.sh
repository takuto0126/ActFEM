...
gmt basemap -JX5/10 -R0/7/0/20 -Bxa1+l"Iteration" -Bya1+l"Normalized RMS misfit"
...
gmt basemap -JX5/3l -R0/7/0.7/200 -Bxa1+l"Iteration" -Bya5+l"Hyper parameter (black)" -Y11 
