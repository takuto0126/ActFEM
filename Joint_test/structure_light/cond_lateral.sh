...
0:elevation,1:depth!0
2d topo file       |../../mesh_joint/nakadake2dz.msh
# of cuboid        !5
...
C22 rho    [Ohm.m] !10.0
C22 ratio          !1.0
C23 xminmax [km]   !-500.00        500.0000
C23 yminmax [km]   !-500.000       500.000
C23 zminmax [km]   !-500.0           2.00
C23 rho    [Ohm.m] !100.0
EOF

cat > cond_lateral.ctl <<EOF
!------10!-------20!----
input 3d mshfile   !../mesh_light/nakadake3d.msh
0homo,1cond,2model !0
homo resistivity   !100.0
output cond        !./cond_lateral.msh
0:elevation,1:depth!0
# of cuboid        !1
C22 xminmax [km]   !-5.0000        0.0000
C22 yminmax [km]   !-5.0000        5.0000
C22 zminmax [km]   !-5.0000        1.5
C22 rho    [Ohm.m] !10.0
EOF

ctlfile=cond_lateral.ctl
