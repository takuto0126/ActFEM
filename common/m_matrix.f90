...
integer(4) :: i,j,ii
integer(4) :: ntot
integer(4),allocatable,dimension(:,:) :: item_work ! 2022.12.05
integer(4),allocatable,dimension(:) :: row_count   ! 2022.12.05
allocate(row_count(nrow)) ! 2022.12.05
allocate(item_work(nrow,ncolm)) ! 2022.12.05
